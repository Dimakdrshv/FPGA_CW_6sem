...
always @* begin
    casex (T_S_ADDR)
        16'b1001_1011_10xx_xxxx: EN = 8'b00000001; // I0: 9B80h - 9BBFh
        16'h180C:                EN = 8'b00000010; // I1: 180Ch        
        16'h3E61:                EN = 8'b00000100; // I2: 3E61h        
        16'b0101_0000_1111_10xx: EN = 8'b00001000; // I3: 50F8h - 50FBh
        16'b1000_0111_1100_0xxx: EN = 8'b00010000; // I4: 87C0h - 87C7h
        16'b1000_0001_0000_011x: EN = 8'b00100000; // I5: 8106h - 8107h
        16'b0000_0010_0111_0xxx: EN = 8'b01000000; // I6: 0270h - 0277h
        16'b1001_00xx_xxxx_xxxx: EN = 8'b10000000; // I7: 9000h - 93FFh
