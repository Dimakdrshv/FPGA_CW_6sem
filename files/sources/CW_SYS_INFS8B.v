...
// Engineer: Panina T.A.
// 
// Create Date: 05.05.2026 15:44:26
// Design Name: 
// Module Name: CW_SYS_INFS8B
// Project Name: 
// Target Devices: 
// Tool Versions: 
...
always @* begin
    ...
    casex ({T_S_CMD, T_S_ADDR})
        {3'bx01, 16'b1001_1011_10xx_xxxx}: EN[0] = 1'b1; // I0: 9B80h - 9BBFh (Регистры ядра)
        {3'b101, 16'h180C}:                EN[1] = 1'b1; // I1: 180Ch         (Регистр А)
        {3'b101, 16'h3E61}:                EN[2] = 1'b1; // I2: 3E61h         (Регистр B)
        {3'b000, 16'b0101_0000_1111_10xx}: EN[3] = 1'b1; // I3: 50F8h - 50FBh (RGB матрица)
        {3'b000, 16'b1000_0111_1100_0xxx}: EN[4] = 1'b1; // I4: 87C0h - 87C7h (7-сегментные)
        {3'b000, 16'b1000_0001_0000_011x}: EN[5] = 1'b1; // I5: 8106h - 8107h (Светодиоды)
        {3'bx01, 16'b0000_0010_0111_0xxx}: EN[6] = 1'b1; // I6: 0270h - 0277h (Монитор прерываний)
